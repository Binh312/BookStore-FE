          ...
          <div class=" text-center text-md-start mt-5">
            <div class="row mt-3">
              <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                <h6 class="text-uppercase fw-bold mb-4"><i class="fa fa-book"></i> BookStore</h6>
                <p>
                  Chúng tôi cung cấp các loại sách, phù hợp, hấp dẫn, chất lượng cao đến người tiêu dùng
                </p>
              </div>
              ...
              <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                ...
                <p><i class="fas fa-envelope me-3"></i> bookshop@gmail.com</p>
